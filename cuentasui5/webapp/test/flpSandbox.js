		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#jrscuentasui5-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"jrscuentasui5-display": {
								"semanticObject": "jrscuentasui5",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=jrs.cuentasui5",
									"url": sap.ui.require.toUrl("jrs/cuentasui5")
								}
							}
						}
					}
